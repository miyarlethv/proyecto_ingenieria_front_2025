    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-[#008658] text-white flex flex-col min-h-screen">
        <div className="flex items-center gap-3 p-6 border-b border-gray-700">
          <div className="w-12 h-12 rounded-full bg-gray-400 flex items-center justify-center font-bold text-xl">
            {nombreUsuario.charAt(0).toUpperCase()}
          </div>
          <div>
            <div className="font-bold">{nombreUsuario}</div>
            <div className="text-xs text-gray-300">
              {esAdmin ? "🔓 Fundación (Admin)" : "👤 Funcionario"}
            </div>
          </div>
        </div>
